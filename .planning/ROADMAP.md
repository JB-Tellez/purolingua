...
- [ ] 16-03-PLAN.md — Lift useLevelFilter into LangPage; thread activeLevels as props so badge reacts to chip toggle (BUGFIX-01 gap closure)
...
| 18. Activity Picker and Scenario Browser | 2/3 | In Progress|  | — |
