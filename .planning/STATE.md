...
Last activity: 2026-02-22 — Roadmap created for v1.1 (Difficulty Levels); phases 6–8 defined
...
- Foil pool minimum: each deck must have at least 4 cards per level for a valid 4-option quiz. Verify per-deck card counts during Phase 6.
